...
def repeat_string(string, numberoftimes):
...
sign = sign_and_parity(5)[0]
parity = sign_and_parity(5)[1]
...
def add_new_number(number,nums_list):
    return nums_list.append(number)
